...
exports.Main = void 0;
var fs_1 = require("fs");
var check = function (file) { return JSON.parse(fs_1.readFileSync(file, "utf-8")); };
var Main = /** @class */ (function () {
    ...
    Main.prototype.push = function (key, data) {
        if (!key)
            throw TypeError("key parameter is required");
        if (!data)
            throw TypeError("data parameter is required");
        var checkFile = check(this.file);
        try {
    ...
    Main.prototype.math = function (data, operator, num) {
        if (!data)
            throw TypeError("number(1) required");
        if (!num)
            throw TypeError("number(2) required");
        if (!operator)
            throw TypeError("operator required");
        if (typeof data !== "number")
            throw TypeError("number(1) is not a number");
        if (typeof num !== "number")
            throw TypeError("number(2) is not a number");
